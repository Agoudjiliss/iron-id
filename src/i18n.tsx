...
const messages: Record<Lang, Translations> = {
  fr: {
    ...
    "home.subtitle":
      "TrueStamp combine trois couches de protection : signature C2PA, watermark frequentiel et protection anti-IA. Vos images sont authentifiees et verifiables en un clic.",
    ...
    "footer.text": "TrueStamp — Media Auth System",
    "lang.fr": "FR",
    "lang.en": "EN",
    "lang.ar": "AR",
  },
  en: {
    ...
    "home.subtitle":
      "TrueStamp combines three protection layers: C2PA signature, frequency watermark and anti-AI protection. Your images are authenticated and verifiable in one click.",
  ...
  ar: {
    ...
    "home.subtitle":
      "تجمع TrueStamp بين ثلاث طبقات حماية: توقيع C2PA، علامة مائية ترددية وحماية ضد الذكاء الاصطناعي. يتم توثيق صورك ويمكن التحقق منها بنقرة واحدة.",
    ...
    "footer.text": "TrueStamp — نظام توثيق الوسائط",
    "lang.fr": "فر",
    "lang.en": "إن",
    "lang.ar": "عر",
  },
